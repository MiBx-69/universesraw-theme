...
(function () {
  ...
  if (window.__UniversesMobileDrawerInitialized) return;

  window.__UniversesMobileDrawerInitialized = true;
  ...
  function initMobileDrawer() {
    ...
    const panel = drawer.querySelector('[data-drawer-content]');
